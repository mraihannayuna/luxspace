                ...
                <form action="{{ route('dashboard.product.update' , $product->id) }}" method="post" class="w-full" enctype="multipart/form-data">
                    ...
                    @method('PATCH')
                        ...
                        <div class="flex flex-wrap mx-3 mb-6">
                            ...
                            <textarea id="description" type="text" placeholder="Description" name="description" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">{{ old('title') ?? $product->description }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap mx-3 mb-6">
                            ...
                            <input type="numbers" placeholder="Price" value="{{ old('title') ?? $product->price }}" name="price" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                        </div>
                        ...
                        <div class="flex flex-wrap mx-3 mb-6">
                            ...
                            <input type="numbers" placeholder="Quantity" value="{{ old('title') ?? $product->qty }}" name="qty" class="block w-full bg-gray-200 text-gray-700 border-gray-200 rounded py-3 px-4 leading-tight focus:outline-none focus:bg-white focus:border-gray-500">
                            </div>
                        </div>
                        <div class="flex flex-wrap mx-3 mb-6">
